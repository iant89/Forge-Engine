...
| `npm test` | 611 tests in 42 files on the current tree (including Phase 13.7 async pipeline, Phase 13.8 timestamp/readback and Phase 13.9 cascade/spot/point-map coverage); see the per-suite notes below | passing |
