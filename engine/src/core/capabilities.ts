...
const ENTRIES: readonly CapabilityEntry[] = Object.freeze([
  ...
  },
  {
    ...
    phase: "2",
    status: "verified",
    summary: "CPU frustum culling per batch and per directional cascade or spot shadow map",
  ...
  },
  {
    ...
    phase: "2",
    status: "partial",
    summary: "Cascaded directional maps plus up to four shared-resolution spot maps (first directional caster only)",
  ...
  },
  {
    ...
    phase: "2",
    status: "partial",
    summary: "Per-object conservative masks and assigned instance ranges across cascade and spot passes",
    evidence: ["tests/shadows.test.ts", "tests/frame.test.ts"],
    closesWith: "13.9",
    notes: "Casters whose bounds overlap multiple cascade/spot frusta submit to each assigned map; shadowInstancesDrawn/cull stats expose the work. Point, contact shadows and adaptive resolution remain under 13.9.",
  },
  {
    id: "rendering.shadowMemory",
    phase: "2",
    status: "partial",
    summary: "Fixed shared-resolution shadow array, up to eight layers (~128 MiB at 2048²; ~512 MiB at 4096²)",
    evidence: ["tests/shadows.test.ts", "tests/frame.test.ts"],
    closesWith: "13.9",
