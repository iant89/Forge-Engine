...
The demo (`npm run demo`) ships seven scenes: **PBR Showcase** (Phase 2: instanced material grid,
...
`docs/PARTICLES.md`), and **Sky / Day-night** (Phase 8a: a June day at 47°N in six minutes — `[` `]`
scrub the clock, `T` pauses it, `M` swaps Earth for Mars). `?scene=vehicle`, `?scene=particles` and
`?scene=sky` open those directly.
